  ...
  return (
    <div className="hover-zoom">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="our_solution_category"></div>
                ...
                {company}
                   ...
                   {isEditing ? (
                      <div className="d-flex justify-content-center gap-3 p-2">
                        <button type="button" class="read_more_btn"  onClick={handleEdit}>
                          Save
                        </button>
                        <button
                          type="button" class="read_more_btn" 
                      ...
                      <div className="d-flex justify-content-center gap-3">
                        <button type="button" class="read_more_btn" onClick={() => setIsEditing(true)}>
                          Edit
                        </button>
                        <button type="button" class="read_more_btn" onClick={handleDelete}>
                          Delete
                        </button>
                      </div>
                    )}
